...
/**
 * Foreground-service wrapper around the streaming session, purely so Android keeps the
 * process alive/high-priority and shows an ongoing notification while streaming. The
 * actual camera/encoder/network pipeline lives in MainActivity (CameraX's Preview use
 * case needs a visible view + Activity lifecycle to show the on-screen preview).
 */
